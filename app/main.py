...
@app.post("/recipes")
async def create_recipe(title: str, description: str, cuisine: str, db: AsyncSession = Depends(get_db)):
    recipe = await RecipeCrud.create_recipe(db, title, description, cuisine)
